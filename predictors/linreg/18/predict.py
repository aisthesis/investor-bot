...
def get_alldata(n_pred_intervals):
    ...
    n_feat_sess = 256
    fname = "../{0}/features/lngrowth/sma20/sma50/ema20/ema50/risk20/{1}/labels/multi/{2}/combined.npy".format(settings.DATA_ROOT,
...
def _get_featfuncs(pricecol):
    ...
    for _sma_win in _sma_wins:
        ...
        #EMA
        _funcs.append(pn.decorate(partial(pn.tech.ema_growth, selection=pricecol, n_sessions=_sma_win), 
                title=('EMAGrowth' + str(_sma_win))))
    # EMA 20
