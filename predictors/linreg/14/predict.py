"""
Linear regression 14: Multiple metrics as features over 256 sessions.
...
def get_alldata(n_pred_intervals):
    ...
    n_feat_sess = 256
    fname = "../{0}/features/growth/lngrowth/relvol/sma20/ema20/risk20/{1}/labels/multi/{2}/combined.npy".format(settings.DATA_ROOT,
