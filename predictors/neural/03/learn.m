...
function [theta1, theta2, lambda, cost] = learn(weightsId)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% parameters
params = {};
params.weightsId = weightsId;
params.trainFile = "splitadj/closes/train60xval20test20/train/features/256/labels/64/bullish/100pct/mean0/std100pct/combined.mat";
